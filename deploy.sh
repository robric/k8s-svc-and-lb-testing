...
multipass exec vm1 -- bash -c 'curl -sfL https://get.k3s.io | K3S_TOKEN="36d331cf-91d7-4489-b558-cd0186f8167f" K3S_KUBECONFIG_MODE="644" INSTALL_K3S_EXEC="server --cluster-init --disable servicelb" sh -'
...
for i in $(seq 2 $NUM_NODES); do
  ...
  multipass exec vm$i -- bash -c "curl -sfL https://get.k3s.io | K3S_TOKEN="36d331cf-91d7-4489-b558-cd0186f8167f" K3S_KUBECONFIG_MODE="644" K3S_URL=https://$FIRST_NODE_IP:6443 sh -"
done
